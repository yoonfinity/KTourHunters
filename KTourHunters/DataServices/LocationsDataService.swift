...
class LocationsDataService {
    ...
    static let locations: [Location] = [
        ...
        Location(
            ...
            description: "Changdeokgung (Korean: 창덕궁; Hanja: 昌德宮) is a former royal palace in Seoul, South Korea. A UNESCO World Heritage Site and a Historic Site of South Korea, it is among the best preserved of all Korean palaces. It and its neighboring palace Changgyeonggung have together been called the \"East Palace\".",
            imageNames: [
